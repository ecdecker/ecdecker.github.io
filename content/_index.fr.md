...
{{< principle key="serif" meta="Énergie" >}}
### Transitions énergétiques propres.

Comment les politiques publiques et la finance peuvent rendre la
décarbonation plus efficace, durable et équitable.
{{< /principle >}}

{{< principle key="hairlines" meta="Santé" >}}
### Santé environnementale.

Comment de meilleures mesures et données économiques peuvent améliorer les
décisions de santé publique dans l'incertitude.
{{< /principle >}}

{{< principle key="ink" meta="Résilience" >}}
### Résilience climatique.

Comment les ménages, les communautés, les entreprises et les pouvoirs publics
se préparent aux chocs climatiques et s'en remettent.
{{< /principle >}}
